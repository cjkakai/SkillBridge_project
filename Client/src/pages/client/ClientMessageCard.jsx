...
const ClientMessageCard = ({ freelancer, latestMessage, unreadCount, onClick, isSelected }) => {
  ...
  return (
    <div className="message-card" onClick={onClick} style={{ borderRadius: '8px', padding: '10px', marginBottom: '10px', position: 'relative', cursor: 'pointer', transition: 'background-color 0.2s', backgroundColor: isSelected ? 'royalblue' : 'transparent', color: isSelected ? 'white' : 'black', display: 'flex', alignItems: 'center', gap: '10px' }} onMouseEnter={(e) => !isSelected && (e.target.style.backgroundColor = '#f5f5f5')} onMouseLeave={(e) => !isSelected && (e.target.style.backgroundColor = 'transparent')}>
      <img
      ...
      />
      <div className="freelancer-info" style={{ flex: 1, backgroundColor: 'white' }}>
